...
class Dock:
  ...
  def moveCrates(self, fromColumnIndex, toColumnIndex, amount):
    newStack = []
    ...
    while i < amount:
      ...
      newStack.insert(0, crateToMove)
    for crate in newStack:
      toColumn.append(crate)
...
class Orchestrator:
  ...
  def run(self):
    for instruction in self.instructions:
      self.dock.moveCrates(instruction.fromColumnIndex, instruction.toColumnIndex, instruction.repetitions)
