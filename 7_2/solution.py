...
fileDiskSize = 70000000
spaceRequired = 30000000
spaceUsed = iterator.root.getSize()

spaceFree = fileDiskSize - spaceUsed
spaceWeNeedToCleanUp = spaceRequired - spaceFree

cleanupCandidateSize = fileDiskSize

for d in directories:
  size = d.getSize()
  if size >= spaceWeNeedToCleanUp and size < cleanupCandidateSize:
    cleanupCandidateSize = size

print(cleanupCandidateSize)
